...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center', fig.cap="OSI Model"}
setwd("~/rDia")
...
### Packet Analysis
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.width=4.5, fig.height=5, fig.align='center', fig.cap="Source Packet Size Boxplot"}
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.cap="Bar Charts Packets by Source"}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.cap="3D Scatterplot of MODBUUS Reference and Data Over Time of Function Code 4"}
...
In Figure 9, an example is shown of the placement of the IDS and its supporting DB, connected to other SCADA components.
...
setwd("~/rDia")
img <- readPNG("imgs/arch_sys_detect.png")
grid.raster(img)
```
...
Figure 11 shows the steps involved in the entire process from acquiring the data, computation and analysis, to setting the IDS to detection mode.
...
```{r, echo=FALSE, fig.width=5, fig.height=3, fig.align='center', fig.cap="Process"}
setwd("~/rDia")
...
# Appendix C - MODBUS/TCP Request/Response Packet Statistics {-}
...
# Appendix D - Merged Request/Response Packet Statistics {-}
...
# Appendix E - Commands and Scripts {-}
