...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.pos='h', fig.width=4.5, fig.height=4, fig.align='center', fig.cap="3D Scatterplot of MODBUS Reference Number\n and Data Over Time for Function Code 4"}
...
In Table 12, we see MODBUS function code 90 sent to perform administrative commands without authentication.
