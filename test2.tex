...
\caption{SCADA components [Zhu2010]}\label{fig:unnamed-chunk-3}
\end{figure}
...
\caption{OSI Model}\label{fig:unnamed-chunk-4}
\end{figure}
...
\caption{TCP Header}\label{fig:unnamed-chunk-5}
\end{figure}
...
\caption{MODBUS TCP/IP Communication Architecture}\label{fig:unnamed-chunk-7}
\end{figure}
...
{\centering \includegraphics{test2_files/figure-latex/unnamed-chunk-8-1} 

}

\caption{MODBUS/TCP Frame}\label{fig:unnamed-chunk-8}
\end{figure}
...
{[}3, 4{]} define threats and vulnerabilities, security issues, as well
as policies and best practices, and recommendations on how to best
...
little has been published, except for the work done by Digital Bond.
...
{[}3{]}B. Hadžiosmanović D and P. Hartel, ``Through the eye of the
...
{[}4{]}M. Krotofil and D. Gollmann, ``Industrial control systems
